...
<body>
  <div class="container">     
    ...
    <section class="main">
      ...
      <div class="row">
        <a href="CustomerDetails.php">See all</a>
      </div>
            ...
            <form action="" method="POST">
                <table>
                   ...
                   <?php
                    ...
                    // Build the SQL query
                    $sql = "SELECT user_id,name,email,user_phnum,user_address FROM login WHERE type = 'user'";
                    if (!empty($search)) {
                    ...
                    ?>
                                ...
                                <button type="button" class="btn" onclick="window.location.href='register.php'">Add More</button>
